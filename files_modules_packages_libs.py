...
with open("story.txt", "w") as file:
   file.write("Once upon a time in Python land") 
...
reports_path_os = os.path.join(home_directory,"reports")
print(f"Using os: {reports_path_os}")

from pathlib import Path
reports_path_pathlib = Path.home()/"reports"
print(f"using pathlib: {reports_path_pathlib}")
...
# Task: Parse "2024-07-04 18:30" and calculate how many days ago it was
# Expected output example (if today = 2025-09-22):
# That was 445 days ago.
from datetime import datetime
event_string = "2024-07-04 18:30"
event_date = datetime.strptime(event_string, "%Y-%m-%d %H:%M")
today = datetime.now()
